...
Run:
    python fetch_tase_universe.py

Output:
    tase_universe_full.xlsx  — all .TA tickers with name, sector coverage, validity
"""
...
def main():
    ...
    # ── Export to Excel ───────────────────────────────────────────────────────
    out_path = os.path.join(os.path.dirname(__file__), "tase_universe_full.xlsx")
