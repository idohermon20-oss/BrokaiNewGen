...
Outputs:
  data/maya_companies_full.xlsx  — company ID, Hebrew name, pseudo-ticker
...
Run (from project root):
    python utils/fetch_maya_companies.py
"""
...
def main():
    ...
    # Export to data/
    out_path = str(_Path(__file__).parent.parent / "data" / "maya_companies_full.xlsx")
